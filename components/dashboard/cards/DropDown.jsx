  ...
  return (
    <div className="  w-10 md:w-max ">
      <Menu as="div" className="relative inline-block text-left">
        ...
        >
          <Menu.Items className="absolute right-0 mt-2 w-56 origin-top-right divide-y divide-gray-100 dark:divide-gray-700 rounded-md bg-white dark:bg-[#27272a] shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
