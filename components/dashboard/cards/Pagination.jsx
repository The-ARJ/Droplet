        ...
        <IconButton
          ...
          className={`rounded-full flex justify-center items-center ${
            active === i
              ...
              : "bg-purple-200 dark:bg-[#27272a] dark:text-gray-200 text-black"
          }`}
        >
          {i}
        </IconButton>
  ...
  return (
    <div className="flex justify-center items-center gap-4 mt-14">
      <Button
        variant="text"
        color="blue-gray"
        className="flex bg-purple-200  dark:bg-[#27272a] dark:text-gray-200 items-center gap-2 rounded-full"
        onClick={prev}
        disabled={active === 1}
      >
      ...
      <Button
        variant="text"
        color="blue-gray"
        className="bg-purple-200 dark:bg-[#27272a] dark:text-gray-200 flex items-center gap-2 rounded-full"
        onClick={next}
