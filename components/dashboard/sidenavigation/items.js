...
const style = {
  ...
  logoutButton: 'flex items-center justify-start my-1 p-3 w-full bottom-20 absolute',
};
    ...
    <>
      ...
      {open ? (
        <div className={`${style.logoutButton}`}>
          <button
            className={`p-1 flex gap-6 text-red-200 ${style.title} ${open ? style.open : style.close}`}
        ...
        <div onClick={handleLogout} className="flex items-center  justify-center py-4 text-red-200 font-bold">
