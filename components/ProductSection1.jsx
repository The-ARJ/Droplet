          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <ul role="list" className="space-y-2 sm:space-y-4">
              ...
              <li className="flex space-x-3">
                ...
                {/* End Solid Check */}
                <span className="text-sm sm:text-base text-gray-500">
                  Hundreds of thousands saved. Cardova helps you save valuable
                  time and resources by eliminating the need for physical
                  business cards and expensive printing costs.
                </span>
              </li>
              <li className="flex space-x-3">
                {/* Solid Check */}
